...
import { 
  LucideArrowLeft, LucideCheckCircle, LucideShield, LucideZap, LucideCar, LucideMenu, LucideSparkles, LucideX, LucideArrowRight, LucideChevronLeft, LucideChevronRight
} from 'lucide-react';
...
export default function CarDetailsPage() {
  ...
  const [aiMessages, setAiMessages] = useState<any[]>([{ role: 'ai', text: "Hello! Any questions about this car?" }]);
  ...
  return (
    <div className={`bg-[#0f172a] min-h-screen text-white selection:bg-teal-500 selection:text-white ${outfit.className}`}>
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative pt-24 pb-12 lg:h-[80vh] flex flex-col lg:flex-row">
